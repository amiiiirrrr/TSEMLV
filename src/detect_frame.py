...
class DetectionYolo:
    ...
    def __init__(self, args):
        ...
        # self.names_refined = [ "GO","RL","RHD","GB","LL","LO","FL","LHD","ST","DC","LPG",
        #   "LPS","OV","BD","RPS","AC","RPG","UJ","LJ",
        #   "UI","LI","Tumor","SI","AP","CC","SC","TC","UT",
        #   "SPL","SPR", "AW"]
        
        # [
        # "GO","RL","RHD","GB","LL","LO","FL","LHD","ST","DC","LPG",
        # "LPS","OV","TU","BD","RPS","AC","RPG","UJ","MUJ","LJ","MLJ",
        # "UI","MUI","LI","MLI","Tumor","SI","AP","CC","SC","TC","UT",
        # "SPL","RSC","AS","SPR"
        # ]
